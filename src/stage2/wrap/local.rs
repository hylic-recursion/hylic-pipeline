...
pub trait WrapLocal: Wrap {
    fn build_wrap_init<UN, H, R, W>(w: W) -> ShapeLift<Local, Self::Of<UN>, H, R, Self::Of<UN>, H, R>
    where
        UN: Clone + 'static,
        H: Clone + 'static,
        R: Clone + 'static,
    ...
    fn build_wrap_accumulate<UN, H, R, W>(w: W) -> ShapeLift<Local, Self::Of<UN>, H, R, Self::Of<UN>, H, R>
    where
        UN: Clone + 'static,
        H: Clone + 'static,
        R: Clone + 'static,
    ...
    fn build_wrap_finalize<UN, H, R, W>(w: W) -> ShapeLift<Local, Self::Of<UN>, H, R, Self::Of<UN>, H, R>
    where
        UN: Clone + 'static,
        H: Clone + 'static,
        R: Clone + 'static,
    ...
    fn build_zipmap<UN, H, R, Extra, M>(m: M) -> ShapeLift<Local, Self::Of<UN>, H, R, Self::Of<UN>, H, (R, Extra)>
    where
        UN: Clone + 'static,
        H: Clone + 'static,
        R: Clone + 'static,
    ...
    fn build_filter_edges<UN, H, R, P>(pred: P) -> ShapeLift<Local, Self::Of<UN>, H, R, Self::Of<UN>, H, R>
    where
        UN: Clone + 'static,
        H: Clone + 'static,
        R: Clone + 'static,
    ...
    fn build_memoize_by<UN, H, R, K, KeyFn>(key_fn: KeyFn) -> ShapeLift<Local, Self::Of<UN>, H, R, Self::Of<UN>, H, R>
    where
        UN: Clone + 'static,
        H: Clone + 'static,
        R: Clone + 'static,
    ...
    fn build_wrap_visit<UN, H, R, W>(w: W) -> ShapeLift<Local, Self::Of<UN>, H, R, Self::Of<UN>, H, R>
    where
        UN: Clone + 'static,
        H: Clone + 'static,
        R: Clone + 'static,
...
impl WrapLocal for Identity {
    fn build_wrap_init<UN, H, R, W>(w: W) -> ShapeLift<Local, UN, H, R, UN, H, R>
    where
        UN: Clone + 'static,
        H: Clone + 'static,
        R: Clone + 'static,
    ...
    fn build_wrap_accumulate<UN, H, R, W>(w: W) -> ShapeLift<Local, UN, H, R, UN, H, R>
    where
        UN: Clone + 'static,
        H: Clone + 'static,
        R: Clone + 'static,
    ...
    fn build_wrap_finalize<UN, H, R, W>(w: W) -> ShapeLift<Local, UN, H, R, UN, H, R>
    where
        UN: Clone + 'static,
        H: Clone + 'static,
        R: Clone + 'static,
    ...
    fn build_zipmap<UN, H, R, Extra, M>(m: M) -> ShapeLift<Local, UN, H, R, UN, H, (R, Extra)>
    where
        UN: Clone + 'static,
        H: Clone + 'static,
        R: Clone + 'static,
    ...
    fn build_map_r_bi<UN, H, R, RNew, Fwd, Bwd>(fwd: Fwd, bwd: Bwd) -> ShapeLift<Local, UN, H, R, UN, H, RNew>
    where
        UN: Clone + 'static,
        H: Clone + 'static,
        R: Clone + 'static,
    ...
    fn build_filter_edges<UN, H, R, P>(pred: P) -> ShapeLift<Local, UN, H, R, UN, H, R>
    where
        UN: Clone + 'static,
        H: Clone + 'static,
        R: Clone + 'static,
    ...
    fn build_memoize_by<UN, H, R, K, KeyFn>(key_fn: KeyFn) -> ShapeLift<Local, UN, H, R, UN, H, R>
    where
        UN: Clone + 'static,
        H: Clone + 'static,
        R: Clone + 'static,
    ...
    fn build_map_n_bi<UN, UN2, H, R, Co, Contra>(co: Co, contra: Contra) -> ShapeLift<Local, UN, H, R, UN2, H, R>
    where
        UN: Clone + 'static,
        UN2: Clone + 'static,
        H: Clone + 'static,
    ...
    fn build_wrap_visit<UN, H, R, W>(w: W) -> ShapeLift<Local, UN, H, R, UN, H, R>
    where
        UN: Clone + 'static,
        H: Clone + 'static,
        R: Clone + 'static,
    ...
    -> ShapeLift<Local, UN, H, R, UN, ExplainerHeap<UN, H, ExplainerResult<UN, H, R>>, ExplainerResult<UN, H, R>>
    where
        UN: Clone + 'static,
        H: Clone + 'static,
        R: Clone + 'static,
...
impl WrapLocal for SeedWrap {
    fn build_wrap_init<UN, H, R, W>(w: W) -> ShapeLift<Local, SeedNode<UN>, H, R, SeedNode<UN>, H, R>
    where
        UN: Clone + 'static,
        H: Clone + 'static,
        R: Clone + 'static,
    ...
    fn build_wrap_accumulate<UN, H, R, W>(w: W) -> ShapeLift<Local, SeedNode<UN>, H, R, SeedNode<UN>, H, R>
    where
        UN: Clone + 'static,
        H: Clone + 'static,
        R: Clone + 'static,
    ...
    fn build_wrap_finalize<UN, H, R, W>(w: W) -> ShapeLift<Local, SeedNode<UN>, H, R, SeedNode<UN>, H, R>
    where
        UN: Clone + 'static,
        H: Clone + 'static,
        R: Clone + 'static,
    ...
    fn build_zipmap<UN, H, R, Extra, M>(m: M) -> ShapeLift<Local, SeedNode<UN>, H, R, SeedNode<UN>, H, (R, Extra)>
    where
        UN: Clone + 'static,
        H: Clone + 'static,
        R: Clone + 'static,
    ...
    fn build_filter_edges<UN, H, R, P>(pred: P) -> ShapeLift<Local, SeedNode<UN>, H, R, SeedNode<UN>, H, R>
    where
        UN: Clone + 'static,
        H: Clone + 'static,
        R: Clone + 'static,
    ...
    fn build_memoize_by<UN, H, R, K, KeyFn>(key_fn: KeyFn) -> ShapeLift<Local, SeedNode<UN>, H, R, SeedNode<UN>, H, R>
    where
        UN: Clone + 'static,
        H: Clone + 'static,
        R: Clone + 'static,
    ...
    fn build_wrap_visit<UN, H, R, W>(w: W) -> ShapeLift<Local, SeedNode<UN>, H, R, SeedNode<UN>, H, R>
    where
        UN: Clone + 'static,
        H: Clone + 'static,
        R: Clone + 'static,
